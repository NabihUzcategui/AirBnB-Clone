...
class _AppCalendarState extends State<AppCalendar> {
  ...
  Widget build(BuildContext context) {
    return SfDateRangePicker(
      onSelectionChanged: _onSelectedChange,
  ...
  void _onSelectedChange(DateRangePickerSelectionChangedArgs args) {
    print(args.value);
  }
}
...
class CalendarOptionsSegmentedButtom extends StatefulWidget {
  const CalendarOptionsSegmentedButtom({super.key});

  @override
  State<CalendarOptionsSegmentedButtom> createState() =>
      _CalendarOptionsSegmentedButtomState();
}

class _CalendarOptionsSegmentedButtomState
    extends State<CalendarOptionsSegmentedButtom> {
